        ...
        <div className="p-6">
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                {mode === 'login' 
                  ? 'Sign in to access your wine country trips' 
                  : 'Join us to start planning your wine country adventure'
                }
              </p>
            </div>
            <button
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <button
                onClick={switchMode}
                className="ml-1 text-wine-600 hover:text-wine-700 font-medium"
              >
